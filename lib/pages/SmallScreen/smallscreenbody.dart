...
class SmallScreenBody extends StatelessWidget {
  const SmallScreenBody({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Responsiveness.isSmallScreen(context)? const Text("Database",style: TextStyle(fontSize: 26,fontWeight: FontWeight.bold),):Container(),
                 const  SizedBox(height: 10,),
                  Row(
                    children: [
                    Responsiveness.isSmallScreen(context)?Container(): const   Expanded(child: Text("Database",style: TextStyle(fontSize: 26,fontWeight: FontWeight.bold),),),
